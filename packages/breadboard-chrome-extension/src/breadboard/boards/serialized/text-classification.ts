...
export const serializedClassificationBoard = await board(() => {
...
/* fs.writeFileSync(
	path.join(".", "/src/breadboard/graphs/classificationBoard.json"),
	JSON.stringify(serializedSentimentBoard, null, "\t")
  ); */
